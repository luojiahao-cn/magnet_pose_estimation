...
namespace mag_device_sensor
{
    ...
    namespace
    {
        ...
        inline DriverConfig parseDriverConfig(const XmlRpc::XmlRpcValue &root, const std::string &context)
        {
        ...
        inline TopicConfig parseTopics(const XmlRpc::XmlRpcValue &root, const std::string &context)
        {
            TopicConfig cfg;
        ...
        inline TfConfig parseTf(const XmlRpc::XmlRpcValue &root, const std::string &context)
        {
            TfConfig cfg;
        ...
        inline CalibrationConfig parseCalibration(const XmlRpc::XmlRpcValue &root, const std::string &context)
        {
        ...
        inline NoiseConfig parseNoise(const XmlRpc::XmlRpcValue &root, const std::string &context)
        {
            NoiseConfig cfg;
        ...
        inline SimulationConfig parseSimulation(const XmlRpc::XmlRpcValue &root, const std::string &context)
        {
            const auto sim_ctx = xml::makeContext(context, "simulation");
            const auto &simulation = xml::requireStructField(root, "simulation", context);
    ...
    inline SensorDriverConfigBundle loadSensorDriverConfig(const XmlRpc::XmlRpcValue &root,
    ...
    inline SensorSimulationConfigBundle loadSensorSimulationConfig(const XmlRpc::XmlRpcValue &root,
                                                                   const std::string &context)
    {
        const auto &node = xml::asStruct(root, context);
