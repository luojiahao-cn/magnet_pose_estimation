...
private:
    ...
    void generateRectPath() {
        ...
        corners[0].x = x_center_ - rect_width_/2;  corners[0].y = y_center_ - rect_height_/2;
        corners[1].x = x_center_ + rect_width_/2;  corners[1].y = y_center_ - rect_height_/2;
        corners[2].x = x_center_ + rect_width_/2;  corners[2].y = y_center_ + rect_height_/2;
        corners[3].x = x_center_ - rect_width_/2;  corners[3].y = y_center_ + rect_height_/2;
